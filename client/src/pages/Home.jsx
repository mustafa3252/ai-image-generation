...
const Home = () => {
  ...
  const [searchText, setSearchText] = useState('dfsa');
  ...
  return (
    <section className="max-w-7xl mx-auto">
      ...
      <div>
        ...
        <p className="mt-2 text-[#66  6e75] text-[16px] max-w[500px]">Browse through a collection of imaginative and visually stunning images generated by DALL-E AI</p>
